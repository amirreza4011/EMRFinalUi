...
export class DrugRecordService {
  private urlDrugRec = namedata.API_URL.toString() + '/api/DrugStore/Get_HistoryofPrescriptions';
  private  urlDrugItem = namedata.API_URL.toString() + '/api/DrugStore/Get_HistoryofPrescriptionItems';
